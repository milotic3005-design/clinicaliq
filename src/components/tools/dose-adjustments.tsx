...
const DOSE_DATA: DoseAdjustment[] = [
  ...
  { drug: 'Piperacillin-Tazobactam', class: 'Antibiotic', normalDose: '4.5g IV q6h (EI over 4h)', renalMild: '3.375g q6h', renalModerate: '2.25g q6h', renalSevere: '2.25g q8h; HD: 2.25g q8h + extra dose post-HD', hepaticMild: 'No adjustment', hepaticSevere: 'No adjustment', notes: 'Extended infusion (4h) recommended for critically ill' },
  ...
  { drug: 'Levofloxacin', class: 'Antibiotic', normalDose: '750mg IV/PO daily', renalMild: '750mg q48h', renalModerate: '500mg q48h', renalSevere: '500mg q48h', hepaticMild: 'No adjustment', hepaticSevere: 'No adjustment', notes: 'Tendon rupture risk; avoid with steroids' },
  ...
  { drug: 'Daptomycin', class: 'Antibiotic', normalDose: '6-10 mg/kg IV daily', renalMild: 'No adjustment', renalModerate: 'q48h dosing', renalSevere: 'q48h; HD: dose post-HD', hepaticMild: 'No adjustment', hepaticSevere: 'No data; use with caution', notes: 'NOT for pneumonia; check CPK weekly' },
  ...
  { drug: 'Apixaban', class: 'DOAC', normalDose: '5mg PO BID (AFib)', renalMild: 'No adjustment', renalModerate: '2.5mg BID if ≥2 of: age≥80, wt≤60kg, Cr≥1.5', renalSevere: 'Not recommended if CrCl < 15', hepaticMild: 'No adjustment', hepaticSevere: 'Avoid if Child-Pugh C', notes: 'Least renal elimination of DOACs (~27%)' },
  ...
  // Diabetes
  { drug: 'Metformin', class: 'Biguanide', normalDose: '500-1000mg PO BID', renalMild: 'Max 1000mg BID', renalModerate: 'Max 500mg BID', renalSevere: 'CONTRAINDICATED (lactic acidosis)', hepaticMild: 'Avoid', hepaticSevere: 'CONTRAINDICATED', notes: 'Stop if eGFR < 30; hold for contrast procedures' },
