...
const SAFETY_DATA: SafetyEntry[] = [
  ...
  { drug: 'Nitrofurantoin', pregnancy: 'caution', pregnancyNotes: 'Safe in 2nd/3rd trimester. Avoid near term (38+ wks) — neonatal hemolytic anemia risk. Avoid in 1st trimester if alternatives exist.', lactation: 'safe', lactationNotes: 'Compatible. Avoid if infant has G6PD deficiency.', alternatives: 'Cephalexin, Amoxicillin-Clavulanate' },
