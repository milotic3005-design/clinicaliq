      ...
      >
        ...
        <div className="bg-white px-5 py-4 border-b border-slate-200/50 flex-shrink-0">
          <div className="flex justify-between items-start gap-3">
            ...
            <button onClick={onClose} aria-label="Close modal" className="bg-slate-100 hover:bg-slate-200 text-slate-500 p-2 rounded-full transition-colors flex-shrink-0">
              <X className="w-4 h-4" />
            </button>
          </div>
