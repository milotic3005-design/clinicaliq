      ...
      <div className="relative">
        ...
        {isLoading ? (
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-[#1C1C1E] rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        )}
