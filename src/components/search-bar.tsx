        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
          ...
          {query.length > 0 && (
            <button
              ...
              className="text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] rounded-md p-1 transition-colors"
