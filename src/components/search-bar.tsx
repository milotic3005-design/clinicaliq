        ...
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
          ...
          {query.length > 0 && (
            <button
              ...
              className="p-1 text-muted-foreground hover:bg-gray-100 hover:text-[#1C1C1E] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] rounded-full transition-colors"
            >
              <X className="h-4 w-4" />
            </button>
          )}
