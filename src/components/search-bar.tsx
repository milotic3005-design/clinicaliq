      ...
      <div className="relative">
        ...
        {query.length > 0 && (
          <button
            ...
            className={`absolute top-1/2 -translate-y-1/2 p-1 rounded-full text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] ${
              isLoading ? 'right-10' : 'right-4'
            }`}
            onClick={() => {
              setQuery('');
              setSuggestions([]);
