      ...
      <div className="relative">
        ...
        {isLoading ? (
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] rounded-full p-0.5"
            onClick={() => {
              setQuery('');
              setSuggestions([]);
              setShowSuggestions(false);
