      ...
      <div className="relative">
        ...
        {!isLoading && query.length > 0 && (
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#007AFF] focus-visible:ring-offset-2 rounded-full p-1"
            onClick={() => {
              setQuery('');
              setSuggestions([]);
              setShowSuggestions(false);
